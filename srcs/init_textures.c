...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/30 14:05:00 by malafont         #+#    #+#             */
/*   Updated: 2025/07/30 14:05:00 by malafont         ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
void free_textures(t_game *game)
{
    if (game->textures.north_wall.image_ptr)
        mlx_destroy_image(game->mlx.mlx_ptr, game->textures.north_wall.image_ptr);
    if (game->textures.south_wall.image_ptr)
        mlx_destroy_image(game->mlx.mlx_ptr, game->textures.south_wall.image_ptr);
    if (game->textures.east_wall.image_ptr)
        mlx_destroy_image(game->mlx.mlx_ptr, game->textures.east_wall.image_ptr);
    if (game->textures.west_wall.image_ptr)
        mlx_destroy_image(game->mlx.mlx_ptr, game->textures.west_wall.image_ptr);
